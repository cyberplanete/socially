...
///Ce CustomPaint se situe sur les boutons connexion et creation
///Il se deplace horizontalement. Le mouvement est déclenché lorsque connexion ou creation est selectionné.
///Déclenche le mouvement de la pageView gràce à la propriété pageController
...
class MyCustomPaintSignIn extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    if (pageController != null && pageController.position != null) {
      ...
      canvas.drawShadow(myFormPath, kBaseColor, 2.5, true);
